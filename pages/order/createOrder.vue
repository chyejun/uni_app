	...
	<view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				<image class="logo" src="/static/temp/cate4.jpg"></image>
			...
			<view class="g-item">
				...
				<view class="right">
					<text class="title clamp">测试水果数据测试水果数据测试水果数据</text>
					<text class="spec">测试水果数据 L</text>
			...
			<view class="g-item">
				...
				<view class="right">
					<text class="title clamp">测试水果数据测试水果数据测试水果数据测试水果数据测试水果数据</text>
					<text class="spec">测试水果数据 L</text>
					<view class="price-box">
						<text class="price">￥17.8</text>
						<text class="number">x 1</text>
