	...
	<view class="container">
		...
		<view class="hot-floor">
			<view class="floor-img-box">
				<image class="floor-img" src="/static/temp/banner1.jpg" mode="scaleToFill"></image>
			</view>
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
					<view 
		...
		<view class="hot-floor">
			<view class="floor-img-box">
				<image class="floor-img" src="/static/temp/banner2.jpg" mode="scaleToFill"></image>
			</view>
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
					<view 
		...
		<view class="hot-floor">
			<view class="floor-img-box">
				<image class="floor-img" src="/static/temp/banner3.jpg" mode="scaleToFill"></image>
			</view>
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
					<view 
